...
<!-- banner  -->
	<div class="logo-banner">
		<img src="<c:url value="/resources/img/todoicon.png"/>"> <span class="logo-name">VS To Do List</span>
	</div>
...
<!-- about us section-->	
	<div class="index-about-us" id="about-us">
		...
		<div class="about-us-content" id="about-us-content">
			<p>Founded by Vinit Sawant, VSToDo List is a website which helps you to keep track of all the 
				to do list as per the various types and completion status</p>
			<br>
			<p>VS ToDoList is a pet project to demonstrate the learnings from the founders's educational as well as work experience</p>
			<br>
