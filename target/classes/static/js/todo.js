...
function logout()
{
	 ...
	 $.ajax(
       {
        url  : "http://localhost:8080/VSToDoList/logout",
        ...
        success: function(response){
             ...
             window.location.replace("http://localhost:8080/VSToDoList/logout");
	     }
});
}
...
function getAllToDo()
{
	 ...
	 $.ajax(
       {
        url  : "http://localhost:8080/VSToDoList/getToDo",
        contentType: "application/json",
        type:"GET",
        ...
        success: function(response){
	          if(response.statusCode == "401")
              {
	              ...
	              window.location.replace("http://localhost:8080/VSToDoList/401");
               }
               else
              {
	          document.getElementById("msgAllTodo").innerHTML="";
...
function submitToDo()
{
	 ...
	 $.ajax(
       {
        url  : "http://localhost:8080/VSToDoList/add",
        contentType: "application/json",
        type:"POST",
 headers: {
...
var id =  event.target.id;
	 ...
	 $.ajax(
       {
        url  : "http://localhost:8080/VSToDoList/doneToDo",
        contentType: "application/json",
        type:"POST",
 headers: {
            "Accept": "application/json",
...
$(document).on('click', '.delete', function(){
   ...
   var id =  event.target.id;
	 ...
	 $.ajax(
       {
        url  : "http://localhost:8080/VSToDoList/deleteToDo",
        contentType: "application/json",
        type:"POST",
 headers: {
            "Accept": "application/json",
